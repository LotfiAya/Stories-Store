    ...
    <body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item">
                    <img class="d-block w-100" src="diapo/pic2.jpeg" alt="First slide">
                </div>

                <div class="carousel-item active">
                    <img class="d-block w-100 " src="diapo/pic1.jpeg" alt="Second slide">
                </div>

                <div class="carousel-item">
                    <img class="d-block w-100" src="diapo/pic3.jpeg" alt="Third slide">
                </div>

                <div class="carousel-item">
                    <img class="d-block w-100" src="diapo/pic4.jpeg" alt="Forth slide">
                </div>

                <div class="carousel-item">
                    <img class="d-block w-100" src="diapo/pic5.jpeg" alt="Fifth slide">
                </div>
                                ...
                                <form action="" method="POST">
                                    ...
                                    <button onclick="myFunction()" name="add_to_cart"><img src="./images/cart2.png" alt="Add to cart">
                                        <a href="book_details.php?details=<?php echo $fetch_book['bid'];
                                            echo '-name=', $fetch_book['name']; ?>" class="update_btn">Know More
                                        </a>
                                </form>
        ...
        <section class="show-products">
            <div class="box-container">
                ...
                ?>
                            ...
                            <div class="box" style="width: 255px;height: 355px;">
                                <a href="book_details.php?details=<?php echo $fetch_book['bid'];
                                    echo '-name=', $fetch_book['name']; ?>"> <img style="height: 200px;width: 125px;margin: auto;" class="books_images" src="added_books/<?php echo $fetch_book['image']; ?>" alt="">
                                </a>
        ...
        <section class="show-products">
            <div class="box-container">
                ...
                <?php
                    $select_book = mysqli_query($conn, "SELECT * FROM `book_info` Where category='IT'") or die('query failed');
                    if (mysqli_num_rows($select_book) > 0) {
                        while ($fetch_book = mysqli_fetch_assoc($select_book)) {
                ?>
