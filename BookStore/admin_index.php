...
$users_no = $conn->query("SELECT * FROM users_info WHERE user_type='User'") or die('query failed');
...
<html lang="en">
  <head>
    ...
    <title>Stories  & Store Admin</title>
  </head>
  ...
  <body >
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Total price of Pending Orders</h5>
          <p class="card-text"> 
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Total price of Completed Orders</h5>
          <p class="card-text">
