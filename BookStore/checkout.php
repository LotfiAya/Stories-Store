        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="email" name="number" placeholder="phone number">
              <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
              <input type="text" id="adr" name="address" placeholder="Addresss">
              ...
              <div style="padding: 0px;" class="row">
                <div class="col-50">
                  ...
                  <input type="text" id="state" name="country" placeholder="Contry">
                </div>
                <div class="col-50">
                  <label for="zip">Pincode</label>
                  <input type="text" id="zip" name="pincode" placeholder="Pincode">
                </div>
              </div>
            </div>
