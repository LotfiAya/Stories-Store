    ...
    <header>
      ...
      <div class="nav">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="http://localhost/BookStore/index.php#Romance">Romance</a>
            <a href="http://localhost/BookStore/index.php#Knowledge">Knowledge</a>
            <a href="http://localhost/BookStore/index.php#IT">IT</a>
          </div>
        </div>
      ...
      <div class="user-box" style="display: flex; align-items:center;">
        ...
        <?php if(isset($_SESSION['user_name'])){echo' <img style="height:40px; margin-left:10px ;" src="images/ds2.png" class="user-pic" onclick="toggleMenu()" />';}
            ...
            echo'
              <div class="use_links"><a class="link_Btn" style="background-color: rgb(0, 167, 245);
                padding: 6px;
                border-radius: 10px;
                margin-left: 10px;
                color: white;
